...
import top.daoha.infrastructure.gateway.dto.WeixinQrCodeRequestDTO;
import top.daoha.infrastructure.gateway.dto.WeixinQrCodeResponseDTO;
import top.daoha.infrastructure.gateway.dto.WeixinTemplateMessageDTO;
import top.daoha.infrastructure.gateway.dto.WeixinTokenResponseDTO;
...
public class LoginPort implements ILoginPort {
    ...
    public String createQrCodeTicket(String sceneStr) throws IOException {
        ...
        if (null == accessToken) {
            ...
            WeixinTokenResponseDTO weixinTokenRes = call.execute().body();//上面只是填好了数据，这里才是真的发出了请求
